export const ConversionTable = Object.freeze([    
[0x00,	0x0000,	"NULL"],
...
export function translateHexToDecimal(code){
    return parseInt(code, 16);
}
export function CP437CodeToUTF8Code(code){    
    const line = ConversionTable[code];    
    return line[1];
}